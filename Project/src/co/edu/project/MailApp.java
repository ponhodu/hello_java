...
public class MailApp {
	...
	public String sendMail(String from, String to, String subject, String content) {
		String _email = "aeegina@naver.com";
		String _password = "qweasdzxc13";

		System.out.println("가입 승인 메일 보내기~");

//		String subject = "Hello JavaMail API Test";
		String fromMail = from;// "jeongminz887@gmail.com";
		String fromName = "Board Manager";
		String toMail = to;// "aeegina@naver.com"; // 콤마(,) 나열 가능
